 ...
 */   
class Request extends RequestAddition  implements RequestInterface
{
    use MessageTrait;
    ...
    */
    public function newRequest($method        = null, 
        ...
        if (null !== $body && $body instanceof Stream) {
            ...
            $new->body = new Stream('php://temp', 'r');  
        }
    ...
    public function getParsedBody()
    {
        ...
        if (isset($this->bodyParsers[$mediaType]) === true) {
            ...
            if (!is_null($parsed) && !is_object($parsed) && !is_array($parsed)) {
                throw new RuntimeException(ABC_HTTP_INVALID_BODY);
            }
